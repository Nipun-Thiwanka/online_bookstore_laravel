        ...
        <div class=" main-content-area">
            ...
            <div class="summary">
                <div class="order-summary">
                    ...
                    <p class="summary-info"><span class="title">Discount ({{ Session::get('coupon')['code'] }}) <a href="#" wire:click.prevent = "removeCoupon"><i class="fa fa-times text-danger"></i></a> </span><b class="index"> -Rs:{{ number_format($discount,2) }}</b></p>
                    ...
                    <p class="summary-info total-info "><span class="title">Total</span><b class="index">Rs:{{ number_format($totalAfterDiscount) }}</b></p>
                    @else
