        ...
        <div class="row">
                ...
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        <div class="author-info">
                            <p class="author-name">Author: <b>{{ $product->Author }}</b></p>
                        </div>
                         {{-- newly added --}}
                        <div class="publisher-info">
                            <p class="publisher-name">Publisher: <b>{{ $product->Publisher }}</b></p>
                        </div>
                         {{-- newly added --}}
                        <div class="language-info">
                            <p class="language-name">Language: <b>{{ $product->Language }}</b></p>
                        </div>
                        {{-- newly added --}}
                        <div class="pages-info">
                            <p class="pages-name">Pages: <b>{{ $product->Pages }}</b></p>
                        </div>
                        {{-- newly added --}}
            ...
            <div class="single-advance-box col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="wrap-show-advance-info-box style-1 box-in-site">
                    <h3 class="title-box">Related Books</h3>
